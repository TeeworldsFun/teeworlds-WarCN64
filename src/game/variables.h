...
MACRO_CONFIG_INT(SvGGInfiniteAmmo, sv_gg_endless_ammo, 0, 1, 0, CFGFLAG_SERVER, "If gungame is enabled and this var is 1 no weapons will be spawned and ammo will be set to -1")
