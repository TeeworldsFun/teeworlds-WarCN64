...
bool CGameControllerICTF::OnEntity(int Index, vec2 Pos)
{
...
int CGameControllerICTF::OnCharacterDeath(class CCharacter *pVictim, class CPlayer *pKiller, int WeaponID)
{
...
void CGameControllerICTF::DoWincheck()
{
...
bool CGameControllerICTF::CanBeMovedOnBalance(int ClientID)
{
...
void CGameControllerICTF::Snap(int SnappingClient)
{
